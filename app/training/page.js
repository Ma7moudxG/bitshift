...
export default function Training() {
  ...
  return (
    <Main>
      <div className="relative bg-[url('/training-bg.avif')] bg-center bg-cover h-[200px] md:h-[300px] lg:h-[400px]">
          ...
          <div className="flex flex-col gap-10 md:gap-14 max-w-[1200px] mx-auto items-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
              <div className="flex flex-col text-left gap-6 md:gap-8 lg:gap-10 justify-center">
                <h1 className="text-[#35BCDC] font-extrabold text-2xl md:text-3xl lg:text-4xl xl:max-w-[80%]">
              ...
              <div className="flex flex-col justify-center">
                <Image
                  src="/empower-your-team-with-expert-training.avif"
      ...
      <div className="bg-[#F1F7FE] px-8 py-16 flex flex-col gap-12">
        <div className="flex flex-col md:flex-rowitems-center justify-between gap-6 max-w-[1200px] mx-auto">
          <h1 className="text-[#35BCDC] font-extrabold text-2xl md:text-3xl lg:text-4xl text-center">
